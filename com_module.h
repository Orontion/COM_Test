...
//КОСТЫЛЬ! Родительский объект сделан public целиком, а надо бы - только те функции, какие надо
class COM_Module : public QSerialPort
{
    //Объявления публичных процедур (забыл, как это правильно называется...)
public:

    //Отдельный конструктор становится ненужен, т.к. используется конструктор родительского класса
